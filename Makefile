...
GLOVE80_LAYERS   := Graphite Symbol Nav Num NumMirror Fn Mouse Magic Vestnik Rain Dusk

CRADIO_KEYMAP   := config/cradio.keymap
CRADIO_YAML     := draw/cradio.yaml
CRADIO_SVG      := draw/cradio.svg
CRADIO_KEYBOARD := cradio
CRADIO_LAYERS   := Graphite Symbol Nav Num NumMirror Fn Mouse System Vestnik Rain Dusk
...
AURORA_LAYERS   := Graphite Symbol Nav Num NumMirror Fn Mouse System Vestnik Rain Dusk
