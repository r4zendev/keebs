 ...
 * KLOR QMK layout: 5+5 / 6+6 / 6+2+6 / 4+4.
 * The outer keys, center pair, and outer thumb keys remain unused.
 */
#ifdef RAZEN_KLOR_KONRAD
#    define RAZEN_LAYOUT( \
        ...
        LAYOUT_konrad( \
            LT4, LT3, LT2, LT1, LT0,                  RT0, RT1, RT2, RT3, RT4, \
            KC_NO, LM4, LM3, LM2, LM1, LM0,          RM0, RM1, RM2, RM3, RM4, KC_NO, \
            KC_NO, LB4, LB3, LB2, LB1, LB0, KC_NO, KC_NO, RB0, RB1, RB2, RB3, RB4, KC_NO, \
...
#    define RAZEN_LAYOUT( \
        ...
        LAYOUT_polydactyl( \
            ...
            KC_NO, LM4, LM3, LM2, LM1, LM0,          RM0, RM1, RM2, RM3, RM4, KC_NO, \
            KC_NO, LB4, LB3, LB2, LB1, LB0, KC_NO, KC_NO, RB0, RB1, RB2, RB3, RB4, KC_NO, \
                          KC_NO, KC_NO, LH2, LH1,    RH1, RH2, KC_NO, KC_NO \
        )
#endif
...
static void render_oled_status(void) {
    oled_write_ln_P(PSTR("klor"), false);
    render_oled_mods();
    render_oled_caps();
    render_oled_layer();
}

static void render_oled_peripheral(void) {
    oled_write_ln_P(PSTR("klor"), false);
    oled_write_ln_P(PSTR("Peripheral"), false);
    render_oled_caps();
    render_oled_layer();
}
...
bool oled_task_user(void) {
    ...
    if (initialized && master == last_master && mods == last_mods && caps == last_caps && layer == last_layer) {
        return false;
    }
